...
import { type AgentConfig, DEFAULT_CONFIG, loadConfig, saveConfig } from "../services/agentConfig";
  ...
  return (
    ...
    >
      ...
      >
        ...
        <GlassBtn
          onClick={onClose}
          style={{ fontSize: 12, padding: "2px 6px", minWidth: "unset" }}
        >
          ✕
        </GlassBtn>
      </div>
      ...
      >
        <GlassBtn onClick={handleReset} style={{ fontSize: 12 }}>
          Reset
        </GlassBtn>
        <div style={{ flex: 1 }} />
        <GlassBtn accent onClick={handleSave} style={{ fontSize: 12 }}>
          Save
        </GlassBtn>
      </div>
    </div>
